...
if($_SERVER['REQUEST_METHOD']=='POST'){
	...
	VALUES ('$mail', '$ww','$vl','$tv','$an','$ad','$hsnr','$pc','$wp','$tel','$mb','$geslacht','$gb','$access','$ab')";
	...
	<form method="post" action="<?php echo($_SERVER["PHP_SELF"]);?>">;
		<table>
			...
			<tr>
				...
				<td> abbenement</td>
					<?php
						$sql = "SELECT ab_naam FROM  abbonnement";
						$resultaat = mysqli_query($verbinding, $sql);
					
					
					?>
				
				<td><select name="ab" style="width: 150px">
				<?php
					while($rij = mysqli_fetch_array($resultaat)){
						echo ("<option>".$rij['ab_naam']."</option>");
					}
