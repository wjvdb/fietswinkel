...
<html lang="en">
	...
	<body>
		...
		<div class="container-fluid intro" id="about">
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					<h1 class="chain">inloggen</h1>
					 <p class="text-intro">
					 
					<form align=center name="inlog" method="post" action="<?php echo ($_SERVER['PHP_SELF']);?>">
			...
			<div class="row">
				...
				<div class="col-md-4 section-text nopadding">
					<div class="wp4">
						...
						<p> hier moet nog een goed verhaal komen</p>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-4 footer-rightcol">
						...
						<p class="nopadding">Developed by <a href="http://www.peterfinlan.com/">wimjan</a></p>
					</div>
				</div>
			</div>
		</footer>
